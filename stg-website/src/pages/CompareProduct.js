...
const CompareProduct = () => {
  ...
  const product = useSelector((state) => state?.product?.compareProduct);
                  ...
                  <div className="col-3">
                    <div className="compare-product-card position-relative">
                      <img
                        ...
                        onClick={() => {
                          dispatch(removeFromCompare(element));
                      ...
                      <div className="compare-product-details">
                        ...
                        <h6 className="price mb-3 mt-3">$ {element?.price}</h6>
